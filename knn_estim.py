...
GLOB_PARAMS = {
    "toy": {
        "raw": {"clf__n_neighbors": (3, 4)},
        "smote": {"samp__k_neighbors": (2, 3), "clf__n_neighbors": (3, 4)},
    },
    "heavy": {
        "raw": {"clf__n_neighbors": tuple(np.arange(2, 30, 2))},
        "smote": {
            "samp__k_neighbors": (2, 3, 5, 10),
            "clf__n_neighbors": tuple(np.arange(2, 30, 2)),
        },
    },
}
